...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/script_consult_chrono.js"></script>
        <!-- jquery CSS File -->
    ...
    <body>
     ...
     %>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>S&Eacute;RIE CHRONOLOGIQUE</h1>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-lg-12 col-sm-12">
                                        <h2 class="card-title">S&eacute;ries
                                                               Chronologiques</h2>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="ddlBanque" name="banque"
