...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/script_colonnes.js"></script>
        <!-- jquery CSS File -->
        <link href="css/jquery-ui.css" rel="stylesheet" type="text/css"></link>
        <title>PageRefColonnes</title>
        <style type="text/css">
    ...
    <body>
        <%
      AnnexeDao axdao = new AnnexeDao();
      request.setAttribute("annexes", axdao.getAllAnnexes());
      request.setAttribute("annexesAjout", axdao.getAllAnnexes());
      request.setAttribute("annexesModif", axdao.getAllAnnexes());
     %>
         
        <%
      ColonneDao extractdao = new ColonneDao();
      request.setAttribute("colonnes", extractdao.getAllColonnes());
     %>
            ...
            <div class="pagetitle">
                ...
                <nav style="--bs-breadcrumb-divider: '>';">
                    <ol class="breadcrumb">
                        ...
                        <%if (p.indexOf(p5.getIdprivilege())!=-1){%>
                         
                        <li class="breadcrumb-item active">Gestion des Colonnes</li>
                        <%}else {%>
                        <li class="breadcrumb-item active">Consultation des Colonnes</li>
                        <%}%>
                    </ol>
                </nav>
            </div>
            <%if (extractdao.getAllColonnes().isEmpty()){%>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-lg-10 col-sm-8">
                                        <h2 class="card-title">Colonne</h2>
                                    </div>
                                    <%if (p.indexOf(p5.getIdprivilege())!=-1){%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button"
                                                       ...
                                                       onclick="modifier('${colonne.idcolonne}')"><i class="bi bi-pencil-square"></i> </a>
                                                     
                                                    <a title="Supprimer"
                                                       class="btn btn-danger rounded-pill"
                                                       style="cursor: pointer;"
                                                       onclick="supprimer('${colonne.idcolonne}')"><i class="bx bxs-trash"></i></a>
                                                </td>
                                                <%}%>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control"
                                       id="code_colonne" name="code_colonne"></input>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                       id="lib_colonne" name="lib_colonne"></input>
                            </div>
                        </div>
                        <div class="row mb-3">
        ...
        <!-- this is the modification form-->
        <div class="modal fade" id="dialogForm2" tabindex="-1"
             style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Modifier une Colonne :</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control"
                                       id="code_colonne2" name="code_colonne2"></input>
                            </div>
                            <div class="col-sm-5"></div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                       id="lib_colonne2" name="lib_colonne2"></input>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-4 col-form-label">ANNEXE :</label>
